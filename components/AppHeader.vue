  ...
  <header class="header fixed top-0 left-0 w-full bg-black z-50 overflow-hidden">
    <div class="running-text relative bg-[#CDFF3E] py-2 laptop:py-2 overflow-hidden">
      <Vue3Marquee :pause-on-hover="true" :clone="true">
        ...
        <NuxtLink to="/personality-quiz" class="flex flex-row justify-center items-center gap-2 px-4 laptop:px-6 py-2 laptop:py-0 laptop:h-10 rounded-full bg-white mr-4">
    ...
    <div class="navbar relative flex flex-row justify-between items-center p-4 laptop:py-4 laptop:px-[120px]">
      <NuxtLink to="/" class="logo inline-block">
        <NuxtImg src="/images/Logo-UM-X-SKZ@2x.webp" alt="UltraMilk X StrayKids" sizes="100px lg:110px" width="114" height="40" loading="lazy" class="w-auto h-10" />
      </NuxtLink>
