    ...
    <div class="container mx-auto py-20 laptop:py-[120px] px-6 laptop:px-0">
      <div class="home-join-content flex flex-col justify-center items-center gap-8 laptop:gap-20 relative">
        ...
        <div class="home-join-content-video w-full aspect-video rounded-3xl overflow-hidden relative">
          ...
          <img src="/images/um-x-skz-video-poster.webp" alt="Join Community" width="1232" height="693" loading="lazy" class="hidden laptop:block w-full h-full object-cover object-center absolute top-0 left-0" :class="{ 'opacity-0 invisible' : onPlay }">
          <img src="/images/um-x-skz-video-poster--m.webp" alt="Join Community" width="312" height="176" loading="lazy" class="block laptop:hidden w-full h-full object-cover object-center absolute top-0 left-0" :class="{ 'opacity-0 invisible' : onPlay }">
